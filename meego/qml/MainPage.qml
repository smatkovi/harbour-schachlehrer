        ...
        Column {
            ...
            PageHeader {
                ...
                description: teacher.dueCards > 0
                             ? qsTr("%n Wiederholungen faellig", "", teacher.dueCards)
                             : qsTr("Heute nichts faellig")
            }
            ...
            Label {
                ...
                text: qsTr("Fuenfzehn Minuten in drei Bloecken: erst die faelligen Wiederholungen, dann ein neues Muster, dann gespielt. Gespielt wird immer.")
            }

            Repeater {
                model: [
                    { title: qsTr("A  Wiederholen"),
                      hint: qsTr("Die faelligen Karten, gemischt ueber die Dimensionen"),
                      keys: ["due", "blockA", "reviews", "dueCards"] },
                    { title: qsTr("B  Neues Muster"),
                      hint: qsTr("Ein Muster, fuenf Stellungen hintereinander"),
                      keys: ["newPattern", "blockB", "pattern"] },
                    { title: qsTr("C  Spielen"),
                      hint: qsTr("Sparring mit Ruecknahme und Erklaerung"),
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Fuenfundzwanzig Aufgaben reichen nicht, um einzelne Fertigkeiten sicher zu trennen. 'Unauffaellig' heisst deshalb meistens: nichts stach heraus - nicht, dass nichts gemessen wurde.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeTiny
                text: qsTr("Fuenfundzwanzig Aufgaben, die sich an dich anpassen. Sie geben eine grobe Einschaetzung und die Reihenfolge, in der du ueben solltest - keine Ratingzahl.")
            }
            ...
            property bool onlineReady: true
            ...
            Label {
                ...
                text: teacher.liveGame
                      ? qsTr("Deine Lichess-Partie laeuft. Solange sie laeuft, ist die Engine aus - nach der Partie sehen wir sie uns an.")
                      : qsTr("Gegen echte Gegner auf Lichess spielen, und die eigenen Lichess-Partien als Material fuer die Fehlerdiagnose holen. Freiwillig: alles andere in dieser App funktioniert ohne Konto.")
            }

            Button {
                anchors.horizontalCenter: parent.horizontalCenter
                visible: content.onlineReady
                text: teacher.liveGame ? qsTr("Zurueck zur laufenden Partie")
                                       : qsTr("Lichess")
                onClicked: {
                    if (teacher.liveGame)
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Gegen jemanden am zweiten Geraet spielen, im WLAN oder ueber "
                           + "Bluetooth. Ohne Konto, ohne Internet.")
            }

            Button {
                anchors.horizontalCenter: parent.horizontalCenter
                text: teacher.duel.playing ? qsTr("Zurueck zur Partie am zweiten Geraet")
                                           : qsTr("Zweites Geraet")
                onClicked: {
