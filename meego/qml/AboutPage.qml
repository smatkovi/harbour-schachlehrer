...
Page {
    ...
    Flickable {
        ...
        Column {
            ...
            PageHeader { title: qsTr("Ueber Schachlehrer") }
            ...
            Label {
                ...
                text: qsTr("Messen, spielen, die eigenen Fehler finden, genau die ueben, nachmessen.")
            }
            ...
            Label {
                ...
                wrapMode: Text.WordWrap
                color: Style.secondaryColor
                text: qsTr("Sie folgt keinem festen Lehrplan. Sie misst, was du kannst, laesst dich spielen, rechnet deine Partie nach, ordnet jeden Fehler einer von fuenfzig Klassen zu und macht aus den meisten davon eine Uebungskarte. Geuebt wird, was dich tatsaechlich Partien kostet.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Stockfish 17.1, GPL-3.0-or-later, als eigenes Programm mitgeliefert und ueber UCI angesprochen. Quelltext und Patch liegen unter /usr/share/licenses/harbour-schachlehrer.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Syzygy-Endspieldatenbanken fuer drei und vier Steine, 70 Dateien, gemeinfrei. Sie machen jedes Grundendspiel exakt benotbar, ohne Netzverbindung.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Zuggenerierung und Regelwerk kommen aus Disservin/chess-library (MIT), auf perft-Stellungen geprueft.")
            }
        }
    }
}
