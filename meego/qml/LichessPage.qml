...
Page {
    ...
    property bool loggedIn: teacher.lichessLoggedIn
    property bool authorising: teacher.lichessState === 1
    ...
    Flickable {
        ...
        Column {
            ...
            Item {
                ...
                Column {
                    ...
                    Label {
                        ...
                        text: qsTr("Waehrend einer Lichess-Partie ist die Engine aus.")
                    }
                    Label {
                        width: parent.width
                        wrapMode: Text.WordWrap
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Oeffnet sich der Browser nicht, ruf diese Adresse auf: %1")
            ...
            Label {
                ...
                text: qsTr("Die Anmeldung laeuft im Browser, damit du siehst, auf welcher Seite du dein Passwort eingibst. Wir bekommen nur einen Schluessel, kein Passwort, und er liegt auf diesem Geraet in einer Datei, die nur diese App lesen kann.")
            }
            ...
            ComboBox {
                ...
                description: qsTr("Ueber die Suchanzeige sind Schnellschach, Turnierschach und Fernschach erreichbar. Blitz nicht - und das ist kein Verlust, denn zum Lernen ist es das falsche Format.")
            ...
            TextSwitch {
                ...
                description: qsTr("Gewertete Partien veraendern deine Lichess-Wertung. Fuer das Lernen macht es keinen Unterschied - die Fehler sind dieselben.")
                checked: page.rated
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Die Suche laeuft. Sie bleibt nur so lange offen, wie die App laeuft.")
            }
            ...
            Repeater {
                ...
                Column {
                    ...
                    Label {
                        ...
                        font.pixelSize: Style.fontSizeTiny
                        text: qsTr("Diese Partieform laesst sich mit dieser App nicht spielen.")
                    }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Auch dabei bleibt unsere eigene Engine aus: die Partie laeuft auf dem Server von Lichess und wird dort nach denselben Regeln geprueft.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Deine schon gespielten Lichess-Partien kommen in dieselbe Datenbank wie deine Uebungspartien. Aus ihnen zieht die Fehlerdiagnose ihr Material - echte Partien gegen echte Gegner sagen mehr ueber deine Fehler als jedes Sparring. Das erste Mal dauert es je nach Anzahl eine Weile, danach kommen nur die neuen dazu.")
            }
            ...
            Label {
                ...
                text: {
                    ...
                    if (!sync)
                        return ""
                    if (sync.running)
                        return qsTr("%1 Partien gelesen, %2 uebernommen.").arg(sync.seen).arg(sync.imported)
                    if (sync.message !== "")
                        return sync.message
