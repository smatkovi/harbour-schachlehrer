...
Item {
    ...
    property string code: PieceCode.normalise(piece)
    property string colour: code === "" ? "" : code.charAt(0)
    property string type: code === "" ? "" : code.charAt(1)

    // Chess_<type><l|d>t45.svg, the Wikimedia Commons file naming.
    property url source: code === ""
        ? ""
