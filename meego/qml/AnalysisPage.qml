    ...
    Flickable {
        ...
        Column {
            ...
            ThinkingIndicator {
                ...
                label: qsTr("Die Partie wird Zug fuer Zug durchgerechnet ...")
            }
            ...
            Label {
                ...
                text: qsTr("Noch keine Partie ausgewertet. Spiele eine Partie zu Ende, dann steht sie hier Zug fuer Zug.")
            }
            ...
            Label {
                ...
                text: qsTr("%n Stellen, an denen etwas schiefging. Aus den meisten wird eine Uebungskarte.", "", page.findings.length)
            }
                ...
                ListItem {
                    ...
                    Column {
                        ...
                        Label {
                            ...
                            text: qsTr("Daraus wird eine Uebungskarte.")
                            color: Style.highlightColor
