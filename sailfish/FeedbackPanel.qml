...
Item {
    ...
    property var feedback: teacher.feedback

    readonly property string sentence: (feedback && feedback.text) ? ("" + feedback.text) : ""
    readonly property bool hasSentence: sentence !== ""
    readonly property bool hasNumber: feedback !== undefined && feedback !== null
