        ...
        Column {
            ...
            PageHeader {
                ...
                description: teacher.dueCards > 0
                             ? qsTr("%n fällig", "", teacher.dueCards)
                             : qsTr("nichts fällig")
            }
            ...
            Label {
                ...
                text: teacher.dueCards > 0
                      ? qsTr("So viele Karten sind heute dran. Sechs Minuten reichen dafür.")
                      : qsTr("Heute ist keine Karte fällig. Neue entstehen von selbst, sobald du eine Partie spielst und auswerten lässt.")
            }
            ...
            Label {
                ...
                text: qsTr("Aus deinen eigenen Partien. Nach jeder Partie wird jeder Zug nachgerechnet; wo etwas schiefging, wird der Fehler einer von fünfzig Klassen zugeordnet, und aus den meisten dieser Klassen entsteht eine Übungskarte mit genau diesem Muster.")
            }
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Der Termin kommt von FSRS: je sicherer du eine Karte beantwortest, desto weiter rückt sie weg. Falsch beantwortet rückt sie nah heran, aber nicht auf null.")
            }
        }
    }
}
