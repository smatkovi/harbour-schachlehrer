...
Page {
    ...
    readonly property var game: teacher.onlineGame
    readonly property var clock: teacher.clocks
    readonly property bool live: teacher.liveGame
    readonly property bool over: !teacher.liveGame && page.game.valid
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                color: Style.secondaryColor
                font.pixelSize: Style.fontSizeExtraSmall
                text: qsTr("Für den ersten Zug gibt es eine Frist. Zieh bald, sonst bricht Lichess die Partie ab.")
            }
            ...
            Row {
                ...
                Button {
                    text: qsTr("Zurücknahme erlauben")
            ...
            Label {
                ...
                color: Style.highlightColor
                font.pixelSize: Style.fontSizeSmall
                text: qsTr("Die Partie ist vorbei — jetzt darf die Engine wieder mitreden. Lass sie durchsehen: Aus deinen eigenen Fehlern werden die Übungskarten, mit denen du weiterkommst.")
            }
