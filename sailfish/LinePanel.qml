...
Column {
    ...
    property var task: teacher.task
    ...
    Label {
        ...
        text: panel.guided
              ? qsTr("Ich ziehe für deinen Gegner. Du bist wieder dran.")
              : qsTr("Gib die ganze Folge ein — auch die Züge deines Gegners.")
    }

    Button {
        anchors.horizontalCenter: parent.horizontalCenter
        visible: panel.entered > 0
        text: qsTr("Zug zurück")
