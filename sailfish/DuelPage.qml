...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            PageHeader {
                title: qsTr("Zweites Gerät")
                description: qsTr("Gegen jemanden am anderen Gerät spielen")
            }
            ...
            Label {
                ...
                text: qsTr("Auf beiden Geräten muss der Schachlehrer laufen. Über WLAN müssen "
            ...
            Label {
                ...
                text: (teacher.duel.browser.localAddresses !== ""
                       ? qsTr("Dieses Gerät im Netz: %1").arg(teacher.duel.browser.localAddresses)
            ...
            Label {
                ...
                text: teacher.duel.bluetooth.available
                      ? qsTr("Keine gekoppelten Geräte. Die beiden Geräte einmal in den "
