...
INC="-I$ROOT/src -isystem $ROOT/third_party/chess-library $(pkg-config --cflags Qt5Core Qt5Sql)"
LIBS="$(pkg-config --libs Qt5Core Qt5Sql)"

for h in EngineProcess Database Analyser Sparring TeacherEngine; do
